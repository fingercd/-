...
2026-09-04 完成代码精简：生产代码净删 1,677 行，Windows/node3 全量测试通过，14 路真实权重 smoke 复核通过；删减边界、提交和验证证据见[精简计划与执行结果](docs/plans/2026-09-03-vadbench-code-simplification.md)。
